...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Seller s2 = new Seller(2,"Roberto","paulocatnya@",new DateTime(1998,4,21),2100,d2);
            Seller s3 = new Seller(3,"Caetano","prcr@",new DateTime(1998,4,21),9000,d3);
            Seller s4 = new Seller(4, "Rodrigues", "op3prcr@", new DateTime(1998, 4, 21), 9000, d3);
            ...
            SalesRecord sr4 = new SalesRecord(4, new DateTime(2018, 4, 15), 2500, SaleStatus.PENDING, s4);
